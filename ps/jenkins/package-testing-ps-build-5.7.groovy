library changelog: false, identifier: 'lib@PS-5.7-test', retriever: modernSCM([
    $class: 'GitSCMSource',
...
void runPlaybook(String action_to_test) {
    ...
    sh '''
        git clone -b ps-5.7-test --depth 1 https://github.com/kaushikpuneet07/package-testing
    '''
