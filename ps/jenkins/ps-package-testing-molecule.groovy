    ...
    library changelog: false, identifier: "lib@kmip-debug", retriever: modernSCM([
        $class: 'GitSCMSource',
    ...
    options {
        ...
        stages {
            ...
            stage('Checkout') {
                steps {
                    deleteDir()
                    git poll: false, branch: "kmip-debug", url: "https://github.com/kaushikpuneet07/package-testing.git"
                }
            }
