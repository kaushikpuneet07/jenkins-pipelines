library changelog: false, identifier: 'lib@pxc-5.7-create', retriever: modernSCM([
    $class: 'GitSCMSource',
...
def setup(){
                ...
                installMoleculeBookworm()
                    sh '''
                        ...
                        git clone https://github.com/kaushikpuneet07/package-testing --branch pxc-5.7-create
                    '''
}
